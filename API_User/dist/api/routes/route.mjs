...
//.mjs
import userDAO from "../repositories/userDAO.mjs";
import avisDAO from "../repositories/avisDAO.mjs";
...
router.route('/avis/:nomLigne/:email/:password')
    ...
    */
    try {
        console.log("POST /avis/:nomLigne/:email/:password");
        if (req.body === null) {
        ...
        req.body.date = dateOftheDay.toISOString()
